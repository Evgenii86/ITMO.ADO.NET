...
namespace ITMO.LabsADO.NET.DataAdapterProgram
{
    public partial class Form1 : Form
    {
        ...
        private SqlConnection NorthwindConnection = new SqlConnection("Integrated Security=SSPI;Persist Security Info=False;Initial Catalog=Northwind;Data Source=MOJ-PK\\SQLEXPRESS");
