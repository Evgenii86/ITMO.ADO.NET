...
namespace ITMO.LabsADO.DBConnection
{
    public partial class Form1 : Form
    {
        ...
        string testConnect = GetConnectionStringByName("DBConnect.ApressFinancialConnectionString");

        OleDbConnection connection = new OleDbConnection();
        //string testConnect = @"Provider=SQLOLEDB.1;Integrated Security=SSPI;Persist Security Info=False;Initial Catalog=ApressFinancial;Data Source=MOJ-PK\SQLEXPRESS";
        private void connection_StateChange(object sender, System.Data.StateChangeEventArgs e)
        {
            connectionToolStripMenuItem.Enabled =
                (e.CurrentState == ConnectionState.Closed);
            disconnectionToolStripMenuItem.Enabled =
